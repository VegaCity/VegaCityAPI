...
namespace VegaCityApp.API.Services.Interface
{
    public interface IOrderService
    {
        ...
        Task<ResponseAPI<IEnumerable<GetOrderResponse>>> SearchAllOrders(int size, int page, string status);
        ...
        Task CheckRentingOrder();
        Task<ResponseAPI> GetDetailMoneyFromOrder(Guid orderId);
    }
}
